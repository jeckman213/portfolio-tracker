    ...
    return (
        <section className="description">
           ...
           <div>
                ...
                <h2>About Us.</h2>
                <div>
                    <p>Three teams enter only one team survives... wait nevermind wrong class. Team Z is a AGILE software development team learning how to develop software under Andrew Gallo.</p>
                    <br />
