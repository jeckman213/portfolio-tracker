      ...
      <React.Fragment>
        ...
        <section className="intro">
            ...
            <div className="cards">  
              ...
              <p>Why not loose fake money BEFORE real money? We want you to use portfolios to master the skills needed to make money without risk</p> 

            </div>
            <div className="cards">  
              <h2><i className="fas fa-id-card-alt"></i>< br/>Team Z Developed</h2>
              <p> Developed by the students in Team Z. Please enjoy this tool and help us make it better by providing feedback via one of the contact channels below</p> 
        ...
        <i className="fas fa-frog"></i>
          ...
          <div>
           <p>Teachers consistently tell us about the positive influence our programs have on their students. The educational impact of Portfolios™ (a TeamZ Product) is unmatched, with proven increases in student attendance, engagement and class participation, and improved academic performance and financial behavior.</p> 
           <br />
